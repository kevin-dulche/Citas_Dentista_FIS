...
class VentanaRecepcionista:
    def __init__(self, usuario):
        self.ventana = Tk()
        self.ventana.title("Recepcionista")
        ...
        botonCerrarSesion = Button(self.ventana, text="Cerrar Sesión", font=("Arial", 16), anchor="center", command=self.regresar)
        botonCerrarSesion.place(x=200, y=500, width=150, height=50)

        botonSalir = Button(self.ventana, text="Salir", font=("Arial", 16), anchor="center", command=self.salir)
